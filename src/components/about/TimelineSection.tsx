...
const timelineData: TimelineItem[] = [
  {
    year: "2019",
    title: "Первые шаги",
    description: "Начало пути в веб-разработке. Первые проекты и формирование подхода к качеству."
  },
  {
    year: "2021",
    title: "Расширение услуг",
    description: "Добавление рекламных услуг и комплексного продвижения брендов в digital."
  },
  {
    year: "2023",
    title: "Премиальный сегмент",
    description: "Фокус на luxury-проектах. Разработка собственной дизайн-системы."
  },
  {
    year: "2024",
    title: "Официальная регистрация",
    description: "Регистрация ИП. Запуск бренда 24ZXC и premium-шаблонов."
  }
];
