    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <motion.div
          ...
          whileTap={{ scale: 0.95 }}
          drag
          dragSnapToOrigin={!isDragging || true}
          ...
          className={`
            ...
            border border-primary/40 rounded-lg cursor-grab active:cursor-grabbing
            transition-colors hover:border-primary/60 hover:from-primary/30
            ${isDragging ? 'z-50 shadow-[0_0_20px_hsl(45_80%_55%/0.5)]' : ''}
          `}
      ...
      <TooltipContent side="top" className="bg-card border-primary/30">
        ...
        <p className="text-xs text-muted-foreground">Перетащите к сундуку</p>
      </TooltipContent>
    </Tooltip>
  );
}
