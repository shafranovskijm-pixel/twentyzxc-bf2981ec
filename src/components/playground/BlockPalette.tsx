...
import { Type, AlignLeft, MousePointer, Image, Minus, Square, ArrowUpDown, List, Quote, Hash, Play, Menu, PanelBottom, Columns, Sparkles, Timer, LayoutGrid, Share2 } from "lucide-react";
