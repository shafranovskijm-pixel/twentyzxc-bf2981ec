...
const projects: Project[] = [
  ...
  {
    title: "База отдыха «Нарва»",
    location: "Приморский край",
    description: "Сайт базы отдыха с галереей, системой бронирования и контактной информацией.",
    tags: ["web"],
    price: "5 000 ₽/мес",
    url: "https://baza-narva.ru/",
  },
  {
    title: "База отдыха «Июль»",
    location: "Приморский край",
    description: "Сайт базы отдыха с информацией о домиках, услугах и ценах. Галерея фотографий и контакты для бронирования.",
    tags: ["web"],
    price: "5 000 ₽/мес",
    url: "https://мойиюль.рф/",
  },
  {
    title: "Школа «Русич»",
    description: "Сайт образовательной организации с информацией об обучении, расписанием и контактами.",
    tags: ["web", "license"],
    price: "5 000 ₽/мес",
    url: "https://школа-русич.рф/",
  },
  {
    title: "Hoysook Laser",
    description: "Сайт производителя промышленного лазерного оборудования. Каталог продукции, технические характеристики и контакты.",
    tags: ["web"],
    price: "5 000 ₽/мес",
    url: "https://hoysooklaser.ru/",
  },
  {
