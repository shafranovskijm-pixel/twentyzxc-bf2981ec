...
const Status = () => {
  return (
    <>
      <Helmet>
        <title>Status — Образовательная организация | 24ZXC</title>
        <meta name="description" content="Кейс: создание сайта и получение лицензии для образовательной организации Status. Решение проблем с доменом и хостингом." />
        <link rel="canonical" href="https://24zxc.ru/projects/status" />
      </Helmet>
